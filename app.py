...
TRANSLATIONS = {
    "en": {
        ...
        # --- Preuve on-chain (accueil) ---
        "oc.eyebrow": "&#9878;&#65039; On-chain proof",
        "oc.h2": "Kaddu is also on-chain, on the Zama Protocol",
        "oc.sub": "Our confidential contracts run live on Sepolia (Zama fhEVM). Encrypted end-to-end, "
                  "verifiable by anyone on Etherscan.",
        "oc.tender": "Tamper-proof tender: sealed bids, computed winner, payment released by citizens.",
        "oc.budget": "The budget ceiling is approved by a confidential community vote.",
        "oc.vote": "Confidential on-chain voting: encrypted ballots, only the total is revealed.",
        "oc.tontine": "Tamper-proof tontine with confidential internal voting, governed on-chain.",
        "oc.view": "View on Etherscan &#8594;",
        "oc.note": "Sepolia testnet · Zama Protocol (fhEVM) · deployed 2026-07-28",
        "oc.contracts_label": "The contracts, live on Sepolia",
        # --- Deux couches (accessible + on-chain) ---
        "two.eyebrow": "Two layers, one confidentiality",
        "two.h2": "A Kaddu for everyone. A Kaddu that is tamper-proof.",
        "two.sub": "The same Zama encryption technology, in two complementary forms: one accessible to "
                   "everyone today, one etched onto the blockchain and verifiable by the whole world.",
        "two.a.badge": "&#127760; Online, for everyone",
        "two.a.h3": "Accessible Kaddu",
        "two.a.p": "Usable right away, no wallet or crypto needed. Zama's FHE encryption protects every "
                   "vote server-side. A simple link or QR code is enough — built for associations, "
                   "tontines and cooperatives.",
        "two.a.cta": "Open Kaddu for free",
        "two.b.badge": "On the blockchain",
        "two.b.h3": "On-chain Kaddu, tamper-proof",
